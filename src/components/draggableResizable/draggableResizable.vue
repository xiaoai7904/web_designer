...
export default {
  ...
  data: function () {
    return {
      ...
      dragging: false,
      zIndex: this.z,
      isLeftAbsorption: false,
      isTopAbsorption: false,
    }
  },
  created: function () {
  ...
  methods: {
    ...
    snapCheck: function () {
      if (this.snap) {
        ...
        if (p.length > 1) {
          let x1 = this.rawLeft
          let x2 = this.rawLeft + this.width
          let y1 = this.rawTop
          let y2 = this.rawTop + this.height
